...
export const loadAuthoritativeCMSData = async (): Promise<BackupData> => {
 ...
 // Merge Firestore data with the complete default CMS structure.
 // This prevents the website from crashing when old/incomplete
 // Firestore data is present.
 ...
 whyChooseUs: Array.isArray(cloudData.whyChooseUs)
 ? cloudData.whyChooseUs
 ...
 zodiacForecasts: Array.isArray(cloudData.zodiacForecasts)
 ? cloudData.zodiacForecasts
 : defaultData.zodiacForecasts,

 premiumReports: Array.isArray(cloudData.premiumReports)
 ? cloudData.premiumReports
 : defaultData.premiumReports,

 blogPosts: Array.isArray(cloudData.blogPosts)
 ? cloudData.blogPosts
 : defaultData.blogPosts,
 ...
 leads: Array.isArray(cloudData.leads)
 ? cloudData.leads
 : defaultData.leads,

 activityLogs: Array.isArray(cloudData.activityLogs)
 ? cloudData.activityLogs
 : defaultData.activityLogs,
